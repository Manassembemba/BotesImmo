-- Recréation de la fonction get_payments_with_details avec le cast correct pour le type énuméré
...
RETURNS TABLE (
    ...
    methode TEXT,  -- Explicitly returning as TEXT to match frontend expectations
    notes TEXT,
