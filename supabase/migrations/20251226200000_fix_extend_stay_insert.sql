-- This migration fixes the extend_stay function to correctly populate all required fields
-- when creating an extension invoice, specifically ensuring `net_total` is not NULL.
