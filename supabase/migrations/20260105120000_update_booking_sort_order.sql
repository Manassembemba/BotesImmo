-- Migration: Changement de l'ordre de tri des réservations
-- Date: 2026-01-05
-- Description: Trie les réservations par date de création (plus récent au plus ancien) au lieu de la date de début de séjour.
