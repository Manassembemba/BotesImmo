-- This migration installs the final version of the extend_stay function.
-- This function correctly handles booking extensions by creating a new, separate invoice
-- for the additional cost, and includes logging for easier debugging.
    ...
    IF v_additional_cost > 0 THEN
        ...
        EXCEPTION
            WHEN OTHERS THEN
                ...
                RAISE; -- Re-throw the exception to ensure the transaction is rolled back
        END;
    ELSE
