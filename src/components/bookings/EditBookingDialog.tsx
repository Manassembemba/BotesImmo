...
import { Edit, User, BedDouble, AlertCircle, AlertTriangle, ShieldAlert } from 'lucide-react';
        ...
        <div className="max-h-[75vh] overflow-y-auto pr-4">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-4">
              ...
              {conflictError && (
                <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 p-3.5 rounded-xl space-y-2.5">
                  <div className="flex items-start gap-2.5 text-amber-800 dark:text-amber-300 font-semibold text-sm">
                    <AlertTriangle className="h-5 w-5 shrink-0 text-amber-600 mt-0.5" />
                    <span>{conflictError}</span>
                  </div>
                  <div className="flex items-center gap-2.5 pt-2 border-t border-amber-200/60 dark:border-amber-800/60">
                    <Checkbox
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <Button
                  ...
                  className={bypassConflict ? "bg-amber-600 hover:bg-amber-700 font-bold" : ""}
                >
                  {updateBooking.isPending ? 'Enregistrement...' : (bypassConflict ? 'Forcer & Enregistrer' : 'Enregistrer')}
                </Button>
              </div>
            </form>
          </Form>
